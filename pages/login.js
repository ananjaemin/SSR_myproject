    ...
    <div className="w-full h-[600px] flex items-center justify-center mt-10">
        <div className='w-3/4 h-full flex items-center justify-center'>
          <div className='w-[417px] h-[504px] bg-stone-200 flex flex-col items-center'>
            ...
            <form method="POST" action="" className="w-full h-full flex flex-col items-center">
                ...
                <input name="password" placeholder=" 패스워드를 입력하세요" className='text-black bg-stone-200 w-[295px] h-[40px] border-solid border-2 border-stone-300'></input>
                </div>
